...
cv2.waitKey(125) 
playsound(r"C:\Users\santh\OneDrive\Desktop\ProjectExpo\squid game\red-light-green-light\sounds\RLGLsong.mp3") 
while True:
    cv2.imshow('Squid Game',cv2.resize(intro, (0, 0), fx = 0.5, fy = 0.5) )
...
if not win:
    ...
    playsound(r"C:\Users\santh\OneDrive\Desktop\ProjectExpo\squid game\red-light-green-light\sounds\kill.mp3")    
    while True:
        cv2.imshow('Squid Game',cv2.resize(kill, (0, 0), fx = 0.5, fy = 0.5) )
        if cv2.waitKey(10) & 0xFF == ord('q'):
            break       
    ...
    cv2.waitKey(125)    
    playsound(r"C:\Users\santh\OneDrive\Desktop\ProjectExpo\squid game\red-light-green-light\sounds\win.mp3") 
